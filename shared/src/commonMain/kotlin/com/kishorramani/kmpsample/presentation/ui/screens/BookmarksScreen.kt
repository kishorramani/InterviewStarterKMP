...
import com.kishorramani.kmpsample.presentation.mvi.BookmarksUiEffect
import com.kishorramani.kmpsample.presentation.mvi.BookmarksUiIntent
...
fun BookmarksScreen(
    ...
    LaunchedEffect(viewModel) {
        viewModel.uiEffect.collectLatest { effect ->
            when (effect) {
                is BookmarksUiEffect.ShowToast -> {
        ...
        Column(
            ...
            if (uiState.bookmarkedArticles.isEmpty()) {
                Box(
                    ...
                    Text(
                        text = "No saved articles yet.\nTap bookmark icon on any story!",
                ...
                LazyColumn(
                    ...
                    items(uiState.bookmarkedArticles, key = { it.id }) { article ->
                        ArticleCard(
                            ...
                            onBookmarkToggle = {
                                viewModel.processIntent(BookmarksUiIntent.RemoveBookmark(article.id))
                            }
                        )
                    }
                }
